...
function pdw_spine_theme_setup() {
	...
	add_image_size('featured', 637, 440, true);
...
function pdw_spine_register_sidebars(){
	...
	register_sidebar(
		array(
			...
			'description' => __( 'WooCommerce Primary Sidebar','spine' ),
...
function pdw_spine_load_styles() {
	...
	if ( 'off' !== _x( 'on', 'Open Sans font: on or off', 'spine' ) ) {
		...
		wp_enqueue_style( 'theme-custom', $admin_dir . 'admin-ajax.php?action=fwf_dynamic_css', array('child-style'), null );
